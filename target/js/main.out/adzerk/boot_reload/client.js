...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__6545,opts){
var map__6546 = p__6545;
var map__6546__$1 = ((((!((map__6546 == null)))?((((map__6546.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6546.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6546):map__6546);
var files = cljs.core.get.call(null,map__6546__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6046__auto___6552 = arguments.length;
var i__6047__auto___6553 = (0);
while(true){
if((i__6047__auto___6553 < len__6046__auto___6552)){
args__6053__auto__.push((arguments[i__6047__auto___6553]));

var G__6554 = (i__6047__auto___6553 + (1));
i__6047__auto___6553 = G__6554;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6550){
var vec__6551 = p__6550;
var opts = cljs.core.nth.call(null,vec__6551,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6551,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6551,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6551,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6551,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6548){
var G__6549 = cljs.core.first.call(null,seq6548);
var seq6548__$1 = cljs.core.next.call(null,seq6548);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6549,seq6548__$1);
});
