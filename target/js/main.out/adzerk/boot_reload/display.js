...
return (function (p__6375){
var vec__6376 = p__6375;
var attr = cljs.core.nth.call(null,vec__6376,(0),null);
var v = cljs.core.nth.call(null,vec__6376,(1),null);
...
var args6377 = [];
var len__6046__auto___6380 = arguments.length;
var i__6047__auto___6381 = (0);
while(true){
if((i__6047__auto___6381 < len__6046__auto___6380)){
args6377.push((arguments[i__6047__auto___6381]));

var G__6382 = (i__6047__auto___6381 + (1));
i__6047__auto___6381 = G__6382;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6377.length)].join('')));
...
var len__6046__auto___6385 = arguments.length;
var i__6047__auto___6386 = (0);
while(true){
if((i__6047__auto___6386 < len__6046__auto___6385)){
args__6053__auto__.push((arguments[i__6047__auto___6386]));

var G__6387 = (i__6047__auto___6386 + (1));
i__6047__auto___6386 = G__6387;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq6384){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6384));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__6388){
var map__6392 = p__6388;
var map__6392__$1 = ((((!((map__6392 == null)))?((((map__6392.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6392.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6392):map__6392);
var data = map__6392__$1;
var message = cljs.core.get.call(null,map__6392__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6392__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6392__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6394 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__6394,goog.events.EventType.CLICK,((function (G__6394,map__6392,map__6392__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6394,map__6392,map__6392__$1,data,message,line,file))
);

return G__6394;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__6395){
var map__6399 = p__6395;
var map__6399__$1 = ((((!((map__6399 == null)))?((((map__6399.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6399.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6399):map__6399);
var data = map__6399__$1;
var message = cljs.core.get.call(null,map__6399__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6399__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6399__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6401 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__6401,goog.events.EventType.CLICK,((function (G__6401,map__6399,map__6399__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6401,map__6399,map__6399__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__6402){
var map__6406 = p__6402;
var map__6406__$1 = ((((!((map__6406 == null)))?((((map__6406.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6406.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6406):map__6406);
var messages = map__6406__$1;
var warnings = cljs.core.get.call(null,map__6406__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6406__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__6408 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__6408,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__6408,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__6409){
var map__6412 = p__6409;
var map__6412__$1 = ((((!((map__6412 == null)))?((((map__6412.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6412.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6412):map__6412);
var messages = map__6412__$1;
var warnings = cljs.core.get.call(null,map__6412__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6412__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__6412,map__6412__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__6412,map__6412__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__6412,map__6412__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__6412,map__6412__$1,messages,warnings,exception))
;
